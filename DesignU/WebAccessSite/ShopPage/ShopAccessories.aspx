<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Default.Master" AutoEventWireup="true" CodeBehind="ShopAccessories.aspx.cs" Inherits="WebAccessSite.ShopPage.ShopAccessories" %>
<asp:Content ID="Content1" ContentPlaceHolderID="maincontent" runat="server">

<hr />
<div class="ShopContainer container-fluid" style="margin-top: 20px;">
    <p class="caption shop-text">Shop Accessories</p>
</div>
<hr />
...
<div class="GeneralContainer">
     ...
     <div class="container-fluid">
         ...
         <div id="noItmsDiv" runat="server" style="display:none">Sorry! No one's made any <span id="noItmType" runat="server"></span> yet.  If you'd like, you can make one <asp:HyperLink id="noItmLink" runat="server">here</asp:HyperLink>.</div>
