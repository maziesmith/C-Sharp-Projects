<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Default.Master" AutoEventWireup="true" CodeBehind="ShopApparel.aspx.cs" Inherits="WebAccessSite.ShopPage.ShopApparel" %>

<asp:Content ID="Content1" ContentPlaceHolderID="maincontent" runat="server">

<hr />
<div class="ShopContainer container-fluid" style="margin-top: 20px;">
    <p class="caption shop-text">Shop Apparel</p>
</div>
<hr />
