...
{
    public partial class ShopApparel : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (queryParam != null)
            {
                if (queryParam == tshirt)
                {
                    ...
                    item1Btn.NavigateUrl = "/ViewItem/ViewItem.aspx?view=shop&id=2";
                }
                ...
                if (queryParam == longsleeve)
                {
                    ...
                    item1Btn.NavigateUrl = "/ViewItem/ViewItem.aspx?view=shop&id=3";
                }
